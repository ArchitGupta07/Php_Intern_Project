  ...
  <div class="col-md-6">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
      <div class="col p-4 d-flex flex-column position-static">
        <strong class="d-inline-block mb-2 text-primary-emphasis">Welcome</strong>
        <h3 class="mb-0"><?php echo $_SESSION['username'] ?></h3>
        <p class="mb-1 text-body-secondary"><?php echo date('Y-m-d'); ?></p>
        <p class="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
        <br>
        <h6>Email:- <?php echo $prof['email'] ?> </h6>
...
<div class="container1 row justify-content-center ">
  ...
  <div class="profile border rounded ">
    ...
    <!-- <h5>email</h5> -->
    <!-- <button class="edit" id="<?php echo $prof['uid']; ?>">Edit</button> -->
...
<script>
  ...
  Array.from(edits).forEach((element) => {
    element.addEventListener("click", (e) => {
      ...
      console.log(tr)
      username = tr.getElementsByTagName("h3")[0].innerText;
      email = tr.getElementsByTagName("h6")[0].innerText;
      mobile = tr.getElementsByTagName("h6")[1].innerText;
